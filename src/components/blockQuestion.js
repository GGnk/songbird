...
function Question() {
	return (
		<div className="random-bird jumbotron rounded">
			<img className="bird-image" src="/assets/img/bird.jpg" alt="bird"/>
			<div>
				<ul className="list-group list-group-flush">
					<li className="list-group-item"><h3>******</h3>
					</li>
					<li className="list-group-item">
						<div className="audio-player">
							<audio src="https://www.xeno-canto.org/sounds/uploaded/RFGQDPLDEC/XC518417-Kj%C3%B8ttmeis%20XC%20Helg%C3%B8ya%20Elias%20A.%20Ryberg20200108133922_079.mp3" hidden="">
							</audio>
							<div className="controls">
								...
								<div className="timebar " style={{ position: 'relative' }}>
									<div className="timebar-bar" style={{ background: 'linear-gradient(to right, rgb(0, 188, 140) 0%, rgb(61, 133, 140) 0%, rgb(115, 115, 115) 0%, rgb(115, 115, 115) 100%)'}}></div>
									<div className="timebar-circle" style={{ left: 0 }}></div>
									<div className="timebar-time-info"><div>00:00</div>
										<div>01:35</div>
									</div>
								</div>
							</div>
